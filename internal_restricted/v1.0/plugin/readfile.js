...
// Capitel 4 Knowledge Representation
	...
	f28_0:'What are fuzzy rule sets?',
		...
		f28_2_f_6:'Within OBIA, we work with objects instead of single picksels. Therefore, we also work on aggregated values (e.g., the mean spectral value within an object). We will explore this more in the next lesson, but for fuzzy sets that means we have usually a more stable assignment that with picksels. Again, sticking with the cups of tea that means we are grouping those cups with the higher temperature and those with the lower ones. We would then compare lets say 85 degree with 65 degree and the judgement is much clearer.',
		...
		f28_3_f_3:'We assume that beginning from a certain value, in this case 50, the  probability increases that the object or the picksel will be a forest. ',
		f28_3_f_4:'We assume that beginning from a certain value, in this case 50, the  probability increases that the object or the picksel will be a forest. And if we have 85. Then we are pretty sure that this is a forest. ',
